...
class Medium1Scene(AbstractScene):
    def __init__(self, screen_height, screen_width) -> object:
        ...
        self.gap = 250  # pixels
        self.tfrequency = 800  # ms, how frequent i want trees
    ...
    def render(self, screen):
        ...
        if self.game_over == False and self.swinging == True:
            ...
            if current_time - self.last_tree > self.tfrequency:
                ...
                btm_tree = Tree(self.screen_width, int(self.screen_height / 2) + tree_height, -1, 200)
                top_tree = Tree(self.screen_width, int(self.screen_height / 2) + tree_height, 1, 200)
